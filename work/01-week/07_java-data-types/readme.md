...
Please take moment to read the [Data Structures](https://en.wikipedia.org/wiki/Data_structure) wikipedia page (Intro, Overview, and Examples).

Data Structures (conceptually) are implemented (practically) in each programming language, in different ways.  
